...
public class ListOfGoals {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, getListOfGoals(), "List of Goals", 1);
		//3. Call the appropriate method to get the number of goals you entered,
		//   and using a pop-up display the number of goals
		JOptionPane.showMessageDialog(null, getNumberOfGoals(), "Number of Goals", 1);
		...
		if(isManyGoals()) {
			JOptionPane.showMessageDialog(null, "Wow that's a lot of goals! Awesome!", "Awesome!", 1);
